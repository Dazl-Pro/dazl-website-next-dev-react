        ...
        <div className="homeowners-container">
          <div className="content-container">
            ...
            <div className="dashboard-section shadow-lg bg-white rounded-4 p-4 p-xl-5 text-center">
              ...
              designed to connect homeowners with licensed and approved* Service
              professionals for their home improvement or home repair needs.
              Based on project-specific details captured during the walk-thru,
              including photos and reports that itemize specific needs, Dazl
              identifies affiliate service pros that have demonstrated
              experience in the needed service areas and that have a geographic
              reach that coincides with the property's general location.
              {/* <span
