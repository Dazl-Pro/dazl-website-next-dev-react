                ...
                <div className="card-body">
                    <div className="row mb-4">
                        <div className="col-md-8">
                            ...
                            <p className="text-muted">{companydata?.address || "200 Main Street, Suite 100"}</p>
                            ...
                            <div className="d-flex flex-column">
                                ...
                                <div className="mb-4 mt-2">
                                    ...
                                    <div className="d-flex flex-wrap gap-2 ">
                                        ...
                                        <h6 className="fw-bold line">Social media:</h6>
                                        <span>  {companydata?.facebook && (
                                            <a
                    ...
                    <div className="mb-4">
                        ...
                        <div className="row ">
                            <div className="col-md-4">
                                <p className="mb-1">
                                    <span className="fw-semibold">Years In Businesse:</span> {companydata?.years_in_business || "Not provided"}
                                </p>
                            </div>
                            <div className="col-md-4">
                                <p className="mb-1">
                            ...
                            <div className="col-md-4">
                                <p className="mb-1">
                                    <span className="fw-semibold">Email:</span> {companydata?.email || "Not provided"}
                                </p>
                            </div>
                        </div>
                    </div>
